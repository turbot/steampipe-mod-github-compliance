...
select
  ...
  case 
    when(b.required_pull_request_reviews is not null and (b.required_pull_request_reviews -> 'require_code_owner_reviews')::bool is true) then ' enforces code owner''s review.' 
