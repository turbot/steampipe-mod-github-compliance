...
control "cis_supply_chain_v100_1_1_3" {
  ...
  query         = query.default_branch_requires_2_pull_request_reviews
...
control "cis_supply_chain_v100_1_1_4" {
  ...
  query         = query.default_branch_must_dismiss_stale_approvals
...
control "cis_supply_chain_v100_1_1_5" {
  ...
  query         = query.default_branch_code_change_review_dismissal_restrictions
...
control "cis_supply_chain_v100_1_1_6" {
  ...
  query         = query.default_branch_requires_code_owners_review
...
control "cis_supply_chain_v100_1_1_9" {
  ...
  query         = query.default_branch_requires_status_checks
...
control "cis_supply_chain_v100_1_1_10" {
  ...
  query         = query.repo_open_branches_are_upto_date_before_merge
...
control "cis_supply_chain_v100_1_1_11" {
  ...
  query         = query.repo_no_open_comments
...
control "cis_supply_chain_v100_1_1_12" {
  ...
  query         = query.default_branch_requires_signed_commits
...
control "cis_supply_chain_v100_1_1_13" {
  ...
  query         = query.repo_linear_history_enabled
...
control "cis_supply_chain_v100_1_1_14" {
  ...
  query         = query.default_branch_protections_apply_to_admins
...
control "cis_supply_chain_v100_1_1_15" {
  ...
  query         = query.default_branch_restrict_push_and_merge
...
control "cis_supply_chain_v100_1_1_16" {
  ...
  query         = query.default_branch_blocks_force_push
...
control "cis_supply_chain_v100_1_1_17" {
  ...
  query         = query.default_branch_setting_block_deletion
...
control "cis_supply_chain_v100_1_2_1" {
  ...
  query         = query.public_repo_has_security_md_file
...
control "cis_supply_chain_v100_1_2_2" {
  ...
  query         = query.org_members_cannot_create_repos
...
control "cis_supply_chain_v100_1_2_7" {
  ...
  query         = query.repo_inactive_more_than_90_days
...
control "cis_supply_chain_v100_1_3_1" {
  ...
  query         = query.repo_inactive_members_review
...
control "cis_supply_chain_v100_1_3_3" {
  ...
  query         = query.org_minimum_administrators_set
...
control "cis_supply_chain_v100_1_3_7" {
  ...
  query         = query.repo_should_have_two_admins
...
control "cis_supply_chain_v100_1_3_9" {
  ...
  query         = query.org_domain_verified
